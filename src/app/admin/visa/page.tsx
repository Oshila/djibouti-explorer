                        ...
                        {req.status === 'pending' && (
                          <>
                            <button
                              ...
                              className="p-2 bg-olive/10 text-olive hover:bg-olive/20 rounded-lg transition-colors"
                              title="Approve"
                            >
                            ...
                            <button
                              ...
                              className="p-2 bg-terracotta/10 text-terracotta hover:bg-terracotta/20 rounded-lg transition-colors"
                              title="Reject"
                            >
