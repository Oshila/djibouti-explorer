          ...
          <div className="lg:col-span-1.5">
            ...
            <div className="mt-4">
              ...
              <div className="flex gap-4">
                <a
                  href="https://web.facebook.com/p/Djibouti-Explorer-61571310953769/?_rdc=1&_rdr#"
                  target="_blank"
                ...
                <a
                  href="https://www.tiktok.com/@djiboutiexplorer"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-cream/40 hover:text-[#000000] transition-all duration-300 hover:scale-110"
                  aria-label="TikTok"
                >
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M12.525.02c1.31-.013 2.61-.018 3.91-.02.063 1.58.566 3.16 1.535 4.43.968 1.27 2.32 2.12 3.84 2.43v3.29c-1.48-.25-2.91-.95-4.09-1.99v6.85c.04 2.18-1.31 4.15-3.29 4.75-1.31.39-2.78.25-4.03-.63-.63-.44-1.17-1.1-1.51-1.86-.67-1.54-.48-3.44.54-4.77 1.08-1.42 2.85-2.12 4.61-1.68v3.34c-.41-.13-.85-.15-1.27-.07-.92.19-1.67.87-2.02 1.71-.27.67-.15 1.42.24 2.02.39.6 1.03 1.02 1.75 1.09.78.08 1.61-.26 2.14-.85.47-.54.67-1.27.55-1.98l-.02-9.98z" />
                  </svg>
                </a>
                <a
